"""
URL configuration for lunchplace project.
...
from menu.views import MenuViewSet, DayMenuViewSet
...
router.register('daymenu', DayMenuViewSet, basename='daymenu')
router.register('vote', VoteViewSet)

urlpatterns = [
    path('custom-auth/', include(urls)),
